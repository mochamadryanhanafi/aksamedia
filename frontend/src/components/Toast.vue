<template>
  <div 
    class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 pointer-events-auto transition-all duration-300 transform translate-x-0"
    role="alert"
  >
    <div 
...
const iconClass = computed(() => {
    switch (props.toast.type) {
        ...
        case 'warning': return 'text-orange-500 bg-orange-100 dark:bg-orange-700 dark:text-orange-200'
